...
public class FIRE extends LinearOpMode {
    ...
    public static double P3H = -1.935;
    ...
    public static double OFFX = -0.2;
    public static double OFFY = 0.0;
    public static double OFFH = 0.014;

    public static double OFFX1 = -0.4;
    public static double OFFY1 = -0.2;
    public static double OFFH1 = 0.005;
