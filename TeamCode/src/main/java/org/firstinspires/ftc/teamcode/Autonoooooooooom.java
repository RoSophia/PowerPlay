...
import static org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceRunner.COLOR_ACTIVE_TURN;
import static org.firstinspires.ftc.teamcode.trajectorysequence.TrajectorySequenceRunner.COLOR_ACTIVE_WAIT;
        ...
        if (!BBBBBBBBBBBBBB) {
            ...
            while (!isStopRequested()) {
                if (P11X != PX1 || P12X != PX2 || P11Y != PY1 || P12Y != PY2) {
                    ...
                    traj = drive.trajectorySequenceBuilder(new Pose2d())
                            ...
                            .lineToLinearHeading(new Pose2d(F * 2 - 10, -16, 0), vc, ac)
                            ...
                            .UNSTABLE_addTemporalMarkerOffset(0.3, () -> s1.setPosition(S1OP)) ///////////////////////////// PRELOAD 1
                            ...
                            .UNSTABLE_addTemporalMarkerOffset(UPD, () -> ridicareSlide.setTargetPosition(TOP_POS))
                            .funnyRaikuCurve(new Pose2d(PX3, PY3, HEAD3), P2, P1)
                            .addTemporalMarker(this::ltime)
                            .UNSTABLE_addTemporalMarkerOffset(0, () -> ridicareSlide.setTargetPosition(TOP_POS - 150))
                            .UNSTABLE_addTemporalMarkerOffset(0.3, () -> s1.setPosition(S1OP)) ///////////////////////////// CONE 1
                            .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                                ridicareSlide.setPower(0.4);
                                ridicareSlide.setTargetPosition(360);
                            })
                            .funnyRaikuCurve(new Pose2d(PX2, PY2, HEAD2), P1, P2) //////////////////////////////////////////// GET CONE 2
                            .addTemporalMarker(this::ltime)
                            .UNSTABLE_addTemporalMarkerOffset(-0.03, () -> s1.setPosition(S1CL))
                            .waitSeconds(0.12)
                            .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                            ...
                            .addTemporalMarker(this::ltime)
                            .UNSTABLE_addTemporalMarkerOffset(0, () -> ridicareSlide.setTargetPosition(TOP_POS - 150))
                            .UNSTABLE_addTemporalMarkerOffset(0.3, () -> s1.setPosition(S1OP)) ///////////////////////////// CONE 2
                            .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                                ridicareSlide.setPower(0.4);
                                ridicareSlide.setTargetPosition(360);
                            })
                            .funnyRaikuCurve(new Pose2d(PX2, PY2, HEAD2), P1, P2) //////////////////////////////////////////// GET CONE 3
                            .addTemporalMarker(this::ltime)
                            .UNSTABLE_addTemporalMarkerOffset(-0.03, () -> s1.setPosition(S1CL))
                            .waitSeconds(0.12)
                            .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                            ...
                            .UNSTABLE_addTemporalMarkerOffset(0.5, () -> ridicareSlide.setTargetPosition(TOP_POS))
                            .funnyRaikuCurve(new Pose2d(PX3, PY3, HEAD3), P2, P1)
                            .addTemporalMarker(this::ltime)
                            .UNSTABLE_addTemporalMarkerOffset(0, () -> ridicareSlide.setTargetPosition(TOP_POS - 150))
                            .UNSTABLE_addTemporalMarkerOffset(0.3, () -> s1.setPosition(S1OP)) ///////////////////////////// CONE 3
            ...
            if (AAAAAAAAAAAAAA) {
                ...
                traj = drive.trajectorySequenceBuilder(new Pose2d())
                        ...
                        .addTemporalMarker(this::ltime)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ridicareSlide.setTargetPosition(TOP_POS - 150))
                        .UNSTABLE_addTemporalMarkerOffset(OPD, () -> s1.setPosition(S1OP)) ///////////////////////////// PRELOAD 1
                        .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                            ridicareSlide.setPower(0.4);
                            ridicareSlide.setTargetPosition(360);
                        })
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(UPD, () -> ridicareSlide.setTargetPosition(TOP_POS))
                        .funnyRaikuCurve(new Pose2d(PX3 + PXC * 3, PY3 + PYC * 3, HEAD3 + HEADC * 4.5), P2, P1)
                        .addTemporalMarker(this::ltime)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ridicareSlide.setTargetPosition(TOP_POS - 150))
