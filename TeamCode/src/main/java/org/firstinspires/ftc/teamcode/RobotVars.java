...
public class RobotVars {
    ...
    public static double SAG = 0.390;     // Grabber Arm Get position
    public static double SAH = 0.600;     // Grabber Arm Hold Position
    public static double SAP = 0.750;     // Grabber Arm Put position
    public static double SAW = 0.500;     // Grabber Arm Wait position

    public static double SBAG = 0.64;     // 4bar Get position
    public static double SBAH = 0.85;     // 4bar Hold position
    public static double SBAP = 0.40;     // 4bar Put position

    public static double SDIF = 0.089;    // Grabber Arm Servo Diff Term
    ...
    public static double SHP = 0.65;      // Grabber Put Heading

    public static double SCO = 0.0;       // Cone Securing Mini Servo Open Position
    public static double SCC = 0.4;       // Cone Securing Mini Servo Close Position
