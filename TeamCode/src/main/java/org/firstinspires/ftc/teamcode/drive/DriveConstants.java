...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 33.83; // cm
    ...
    public static double MAX_VEL = 240;// 254
    public static double MAX_ACCEL = 210;//100;
    ...
    public static double MAX_ANG_ACCEL = 3.832;
